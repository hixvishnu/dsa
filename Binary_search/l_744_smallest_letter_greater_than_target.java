...
lexicographically greater than target. If such a character does not exist, return the first character in 
letters.
...
public class l_744_smallest_letter_greater_than_target {
...
// Wrap around if target >= last element
